...
TRAINING_NAME="${TRAINING_NAME:-o11}"
...
DEFAULT_SEED_NAME="o6-latest"
DEFAULT_SEED_MODEL="../o6/data/latest.bin.gz"
DEFAULT_INITIAL_CHECKPOINT="../o6/data/train/o6/checkpoint.ckpt"
if [ "${SEED_MODEL+x}" != "x" ]
then
...
do
    ...
    (
        ...
        CUDA_VISIBLE_DEVICES="$CUDA_DEVICES" PYTHON="$PYTHON" bash export.sh o11 "$DATA_DIR_ABS" 0
    )
done
