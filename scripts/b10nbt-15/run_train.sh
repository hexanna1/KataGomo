...
TRAINING_NAME="${TRAINING_NAME:-b10nbt-15}"
...
DEFAULT_SEED_NAME="b10nbt-11-latest"
DEFAULT_SEED_MODEL="../b10nbt-11/data/latest.bin.gz"
DEFAULT_INITIAL_CHECKPOINT="../b10nbt-11/data/train/b10nbt-11/checkpoint.ckpt"
if [ "${SEED_MODEL+x}" != "x" ]
then
...
do
    ...
    (
        ...
        CUDA_VISIBLE_DEVICES="$CUDA_DEVICES" PYTHON="$PYTHON" bash export.sh b10nbt-15 "$DATA_DIR_ABS" 0
    )
done
